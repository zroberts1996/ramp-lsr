import { SEARCH_PANEL_TEMPLATE, TAB_TEMPLATE, PROVINCE, SIDE_NAV_TEMPLATE, PLAN_SEARCH } from '../templates/template';
...
export class PanelManager {
    ...
    createPanel(mapApi, configLang) {
        ...
        planPanel.header.title = this.mapApi.getTranslatedText('plugins.clssPlugin.pluginName');
